...
public record LendTokenDetailsBySlot
{
    ...
    public UtxoStatus UtxoStatus { get; init; } = UtxoStatus.Unspent;
    public string SpentTxHash { get; init; }
    public TokenAction ActionType { get; init; }
    public string? ScriptHash { get; set; } = null;

    public LendTokenDetailsBySlot(
        string Subject,
        ulong Slot,
        string TxHash,
        ulong TxIndex,
        ...
        UtxoStatus UtxoStatus = UtxoStatus.Unspent,
    ...
    // {
    //     PostAlonzoTransactionOutput babbage => babbage.Datum switch
    //     {
